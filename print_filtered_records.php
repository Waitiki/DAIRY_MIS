...
if (empty($startDate) || empty($endDate)) {
    die("Invalid parameters. Please provide start date and end date.");
}
...
$filterQuery .= " ORDER BY date_time ASC";
...
while ($row = $result->fetch_assoc()) {
    ...
    if (!in_array($row['farmer_Id'], $uniqueFarmers)) {
        $uniqueFarmers[] = $row['farmer_Id'];
    }
}
...
<head>
    ...
    <title>Filtered Records - Print</title>
    <style>
        @media print {
            body { margin: 0; }
...
<body>
    ...
    <div class="print-container">
        ...
        <div class="receipt-header">
            ...
            <div class="receipt-title">Filtered Records Report</div>
        </div>
        ...
        <div class="receipt-info">
            <div class="info-grid">
                <div class="info-section">
                    ...
                    <div class="info-row">
                        ...
                        <span class="info-value"><?php echo count($records); ?></span>
                    </div>
                    <div class="info-row">
                        <span class="info-label">Unique Farmers:</span>
                        <span class="info-value"><?php echo count($uniqueFarmers); ?></span>
                    </div>
                    <div class="info-row">
                        <span class="info-label">Total Quantity:</span>
                        <span class="info-value"><?php echo number_format($totalQuantity, 2); ?> kg</span>
                    </div>
                    <div class="info-row">
                        <span class="info-label">Total Income:</span>
                        <span class="info-value">Ksh <?php echo number_format($totalIncome, 2); ?></span>
                    </div>
                </div>
                ...
                <div class="info-section">
                    ...
                    <div class="info-row">
                        ...
                        <span class="info-value"><?php echo 'FLT-' . date('Ymd') . '-' . rand(1000, 9999); ?></span>
                    </div>
                    <div class="info-row">
            ...
            <div class="date-range">
                ...
                <?php if (!empty($filterName)): ?>
                    <br>Filtered by Farmer ID: <strong><?php echo htmlspecialchars($filterName); ?></strong>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="records-section">
            ...
            <?php if (!empty($records)): ?>
                <table class="records-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo htmlspecialchars($record['breedOfCow']); ?></td>
                ...
                <div class="total-section">
                    ...
                    <div class="total-row">
                        <span class="total-label">Unique Farmers:</span>
                        <span class="total-value"><?php echo count($uniqueFarmers); ?></span>
                    </div>
                    <div class="total-row">
            ...
            <?php else: ?>
                <div style="text-align: center; padding: 40px; background: #f8f9fa; border-radius: 8px;">
                    ...
                    <p style="color: #6c757d;">No milk collection records found for the specified filters.</p>
                </div>
            <?php endif; ?>
        </div>
        ...
        <div class="receipt-footer">
            ...
            <div class="signature-section">
                ...
                <div class="signature-box">
                    <div>_________________________</div>
                    <div style="margin-top: 10px;">Manager Signature</div>
                </div>
            </div>
